...
const sumSales = transactions.filter(transaction => transaction.type === 'sale')
  // .reduce((transaction => transactions.items).map(transaction => transaction.price))

// CURRENTLY I AM GETTING AN INTERMEDIATE VALUE ERROR BECAUSE I AM RETURNING AN OBJECT NOT A ARRAY
